...
import dj_database_url  # Professional database handling ke liye
...
# Email & Other Secrets
SHOPKEEPER_SECRET = os.environ.get("SHOPKEEPER_SECRET")
...
SHOPKEEPER_USER = os.getenv('SHOPKEEPER_USER')
SHOPKEEPER_PASS = os.getenv('SHOPKEEPER_PASS')
# settings.py ke bilkul niche dalo
